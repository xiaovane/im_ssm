...
import api.emchat.api.ChatRoomAPI;
...
public class EasemobChatRoom implements ChatRoomAPI {
	...
	public Object createChatRoom(final Object payload) {
		return responseHandler.handle(new EasemobAPI() {
			...
			public Object invokeEasemobAPI() throws ApiException {
				return api.orgNameAppNameChatroomsPost(OrgInfo.ORG_NAME, OrgInfo.APP_NAME, TokenUtil.getAccessToken(),
						(Chatroom) payload);
			}
		});
	}
	...
	public Object deleteChatRoom(final String roomId) {
		return responseHandler.handle(new EasemobAPI() {
			...
			public Object invokeEasemobAPI() throws ApiException {
				return api.orgNameAppNameChatroomsChatroomIdDelete(OrgInfo.ORG_NAME, OrgInfo.APP_NAME,
	...
	public Object addSingleUserToChatRoom(final String roomId, final String userName) {
		return responseHandler.handle(new EasemobAPI() {
			...
			public Object invokeEasemobAPI() throws ApiException {
				return api.orgNameAppNameChatroomsChatroomIdUsersUsernamePost(OrgInfo.ORG_NAME, OrgInfo.APP_NAME,
						TokenUtil.getAccessToken(), roomId, userName);
			}
		});
	}
	...
	public Object addBatchUsersToChatRoom(final String roomId, final Object payload) {
		return responseHandler.handle(new EasemobAPI() {
			...
			public Object invokeEasemobAPI() throws ApiException {
				return api.orgNameAppNameChatroomsChatroomIdUsersPost(OrgInfo.ORG_NAME, OrgInfo.APP_NAME,
						TokenUtil.getAccessToken(), roomId, (UserNames) payload);
			}
		});
	}
	...
	public Object removeSingleUserFromChatRoom(final String roomId, final String userName) {
		return responseHandler.handle(new EasemobAPI() {
			...
			public Object invokeEasemobAPI() throws ApiException {
				return api.orgNameAppNameChatroomsChatroomIdUsersUsernameDelete(OrgInfo.ORG_NAME, OrgInfo.APP_NAME,
						TokenUtil.getAccessToken(), roomId, userName);
			}
		});
	}
	...
	public Object removeBatchUsersFromChatRoom(final String roomId, final String[] userNames) {
		 ...
		 public Object invokeEasemobAPI() throws ApiException {
		 return
		 api.orgNameAppNameChatroomsChatroomIdUsersUsernamesDelete(OrgInfo.ORG_NAME,OrgInfo.APP_NAME,TokenUtil.getAccessToken(),roomId,
