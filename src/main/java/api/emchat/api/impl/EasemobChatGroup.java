...
import api.emchat.api.ChatGroupAPI;
	 ...
	 private ResponseHandler responseHandler = new ResponseHandler();
	    ...
	    public Object createChatGroup(final Object payload) {
	        return responseHandler.handle(new EasemobAPI() {
	            ...
	            public Object invokeEasemobAPI() throws ApiException {
	                return api.orgNameAppNameChatgroupsPost(OrgInfo.ORG_NAME.toString(),OrgInfo.APP_NAME.toString(),TokenUtil.getAccessToken().toString(), (Group) payload);
	            }
	        });
	    }
