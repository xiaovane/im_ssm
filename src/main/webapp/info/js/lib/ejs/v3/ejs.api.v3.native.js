...
(function() {
    ...
    var Util = {
        ...
        getCallbackId: function() {
            var BIT_COUNT = 30,
                MAX_LONG_CALLBACK_COUNT = 1000;

            var random = Math.floor(Math.random() * (1 << BIT_COUNT));
...
(function() {
    ...
    ejs.extendModule('contact', [{
        ...
        runCode: function(options, resolve, reject) {
            ...
            newOptions.data = {
                userguids: options.userguids
            };
            newOptions.className = ejs.os.android ? 'com.epoint.baseapp.component.chooseperson.PersonChooseActivity' : 'WPLPersonnelSelectViewController';
           
            ejs.page.openLocal(options, resolve, reject);
        }
...
(function() {
    ...
    ejs.extendModule('navigator', [{
        ...
        runCode: function(options, resolve, reject) {
            ...
            options.text = ejs.innerUtil.eclipseText(options.text, MAX_BTN_TEXT_COUNT);
        ...
        runCode: function(options, resolve, reject) {
            ...
            newOptions.text = ejs.innerUtil.eclipseText(newOptions.text, MAX_BTN_TEXT_COUNT);
...
(function() {
    ...
    ejs.extendModule('page', [{
        ...
        defaultParams: {
            ...
            // 横竖屏,默认为1表示竖屏
            orientation: 1,
            // 是否显示缩放控件，配合页面的meta使用
            isShowZoomControls: 0,
            // 额外数据
            data: {}
        },
        runCode: function(options, resolve, reject) {
            ...
            ejs._callProxy.call(this, ejs.innerUtil.extend(options, {
                success: function(result) {
                    // 转为json，针对closePage的传参优化
                    // page由于是长期回调，所以不需要兼容promise
