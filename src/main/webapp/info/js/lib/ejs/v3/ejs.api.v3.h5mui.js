...
(function() {
    ...
    (function(exports) {
        var ACTION_UNIQUE_ID = 'defaultActionSheetId',
            ACTION_WRAP_UNIQUE_ID = 'defaultActionSheetWrapContent';
        ...
        exports.createActionSheetShow = function(options, callback) {
            ...
            if (!document.getElementById('actionSheetContent')) {
                // 不重复添加
            ...
            mui('#' + ACTION_WRAP_UNIQUE_ID).off();
            mui('#' + ACTION_WRAP_UNIQUE_ID).on('tap', 'li>a', function(e) {
    ...
    (function(exports) {
        ...
        /**
         * mui的PopPicker,单例显示
         * @param {options} options 配置包括
         * data 装载的数据
         * @param {Function} chooseCallBack 选择回调
         */
    ...
    ejs.extendModule('ui', [{
        ...
        runCode: function(options, resolve, reject) {
            waitingDialog.showWaiting(options.message, {});
...
(function() {
    ...
    ejs.extendModule('storage', [{
        ...
        runCode: function(options, resolve, reject) {
            ...
            try {
                for (var realKey in items) {
                    if (!items.hasOwnProperty(realKey)) {
                        continue;
                    }
                    
                    var value = items[realKey];
