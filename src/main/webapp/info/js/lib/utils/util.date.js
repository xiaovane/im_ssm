...
(function(exports) {
    ...
    MyDate.prototype = {
        ...
        isLeapYear: function() {
            return (this.myDate.getYear() % 4 == 0 && ((this.myDate.getYear() % 100 != 0) || (this.myDate.getYear() % 400 == 0)));
        },
        toDate: function() {
        ...
        isMoreThan: function(targetDate, pattern) {
            return this.compare(targetDate, pattern) == 1;
        },
        isLessThan: function(targetDate, pattern) {
            return this.compare(targetDate, pattern) == 2;
        },
        isEqual: function(targetDate, pattern) {
            return this.compare(targetDate, pattern) == 0;
        },
