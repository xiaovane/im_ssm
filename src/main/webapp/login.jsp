...
<body>
	...
	<form action="${pageContext.request.contextPath}/LoginInfo/login.do"
		...
		<DIV
			...
			<P style="padding: 30px 0px 10px; position: relative;">
				...
				<INPUT id="userName" name="userName" class="ipt" type="text"
					placeholder="请输入用户名" value="${UserAdmin.userName }">
			</P>
			...
			<DIV
				...
				<P style="margin: 0px 35px 20px 45px;">
					<SPAN style="float: left;">SSM管理系统</SPAN> 
					<span><font color="red" id="error">${errorInfo }</font></span> 
					<SPAN
						style="float: right;"> 
						<input type="submit"
						style="background: #2e6589; padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;"
						value="登录" />
					</SPAN>
				</P>
			</DIV>
	...
	<div style="text-align:center;padding-top: 30px">Copyright ©
		2017-2020 SSM管理系统  版权所有 whai</div>
</body>
</html>