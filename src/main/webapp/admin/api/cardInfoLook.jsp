...
<body>
	...
	<div class="easyui-panel" title="商户卡券"
		...
		<div class="vote-div">
			<span class="vote-span">结束时间:</span> <input id="c_endTime"
				type="text" class="easyui-datebox" required="required">
		</div>
		<div class="vote-div">
		...
		<div class="vote-div">
			<span class="vote-span">&nbsp;&nbsp;</span>
		    <input type="radio" name="l" value="9" checked="checked" onchange="selectNO(this)">通过
			<input type="radio" name="l" value="-1" onchange="selectNO(this)">退回
		</div>
		<div class="vote-div hidden" id="cardLook">
			<span class="vote-span">退回原因:</span>
			<textarea rows="10" cols="50" id="c_reason"></textarea>
		</div>
