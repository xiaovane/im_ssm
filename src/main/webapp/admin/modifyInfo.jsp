...
<head>
    ...
    <script>
        function submitData() {
            $('#fm').form('submit',{
                url:'${WebUser}/admin/UserAdmin/save.do',
                onSubmit:function() {
            ...
            <table cellspacing="20px">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" id="userName" name="userName" style="width:200px" readonly="readonly" value="${UserAdmin.userName }"/>
                    </td>
                </tr>
                <tr>
                    <td>昵称：</td>
...
<script>
    ...
    ue.addListener('ready',function () {
        UE.ajax.request('${WebUser}/admin/UserAdmin/getUserAdminInfo.do',{
            method: "post",
            async: false,
            data: {},
