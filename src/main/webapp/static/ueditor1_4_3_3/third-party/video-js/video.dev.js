...
// Offset Left
// getBoundingClientRect technique from John Resig http://ejohn.org/WebUser/getboundingclientrect-is-awesome/
 ...
 * http://www.foliotek.com/devWebUser/getting-the-width-of-a-hidden-element-with-jquery-using-width/
 *
...
vjs.Player.prototype.getTagSettings = function(tag){
  ...
  if (tag.hasChildNodes()) {
    ...
    for (i=0,j=children.length; i<j; i++) {
      child = children[i];
      // Change case needed: http://ejohn.org/WebUser/nodename-case-sensitivity/
...
vjs.Player.prototype.listenForUserActivity = function(){
  ...
  // http://ejohn.org/WebUser/learning-from-twitter/
