...
<div class="data_list">
    ...
    <div class="data_list_title">
        <img src="${pageContext.request.contextPath}/static/images/WebUser_show_icon.png" alt="信息">&nbsp;信息
    </div>
    <!-- 主体 -->
    <div>
        <!--标题 -->
        <div class="WebUser_title">
            <h3>
                <strong>${WebUser.title}</strong>
            </h3>
        </div>
        <!-- 信息 -->
        <div class="WebUser_info">
            <!-- 左侧标题信息 -->
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <c:forEach items="${keyWorlds}" var="keyWorld">
                            <!-- 标签显示为超链接 点击查询跟类型 -->
                            &nbsp;&nbsp;<a href="${pageContext.request.contextPath}/WebUser/search.html?q=${keyWorld}">${keyWorld}</a>&nbsp;
                        </c:forEach>
                    </c:otherwise>
                </c:choose>
            </div>
            ...
            <div style="float:right">
                发布于：『
                <fmt:formatDate value="${WebUser.releaseDate}" type="date" pattern="yyyy-MM-dd HH:mm"/>
                』&nbsp;&nbsp; 类别：
                <a href="${pageContext.request.contextPath}/index.html?typeId=${WebUser.blodType.id}">${WebUser.blodType.name}</a>
                阅读(${WebUser.clickHit})&nbsp;&nbsp;;评论(${WebUser.replyHit})
            </div>
        </div>
    </div>
    <br><br>
    ...
    <div style="line-height: 3;background-color:#F8F8FF;">
        <span style="color: #8b2323">作者：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;尊重博主原创文章，转载请注明文章出于此处。</span>
    </div>
    <!-- 水平分割线 -->
    <div class="xian" style="margin: 0 auto; border-top:1px solid #ddd"></div>
    <!-- 主体-->
    <div class="WebUser_content">
        ${WebUser.content}
    </div>
    <!-- 水平分割线 -->
    <div class="xian" style="margin: 0 auto; border-top:1px solid #ddd"></div>
